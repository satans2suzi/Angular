...
var documentController = require('../../controllers/documentary/documentary.controller')
...
router.post('/create', upload.single('documentFile'), documentController.createDocument);
